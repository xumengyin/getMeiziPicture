...
/**
 * Static library version of {@link android.util.LruCache}. Used to write apps that run on API
 * levels prior to 12. When running on API level 12 or above, this implementation is still used; it
 * does not try to switch to the framework's implementation. See the framework SDK documentation for
 * a class overview.
 */
public class LruCache<K, V>
{
     ...
     *                 caused by a {@link #put}. Otherwise it was caused by an eviction or a {@link
     *                 #remove}.
     */
    protected void entryRemoved(boolean evicted, K key, V oldValue, V newValue)
    {
        //DebugLog.verbose("LruCache", "entryRemoved");
    }
